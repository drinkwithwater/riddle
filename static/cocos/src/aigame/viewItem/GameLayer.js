...
gAI.GameLayer = cc.Layer.extend({
    ...
    ctor:function (gameTop) {
	    ...
	    this.userInputCtrl=new gAI.UserInputCtrl(this,gameTop);
        this.addChild(this.userInputCtrl,this.LEVEL_USER);
        
        //var size=cc.director.getWinSize();
        this.areaNode=new gAI.AreaNode(this,gameTop);
        this.addChild(this.areaNode,this.LEVEL_AREA);

        this.unitNode=new gAI.UnitView(this,gameTop);
        ...
        this.typeNode=new gAI.TypeNode(this,gameTop);
